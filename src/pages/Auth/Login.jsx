...
export function Login() {
  ...
  const postLoginData = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("magnetLibraryToken", data.encodedToken);
      localStorage.setItem("magnetLibraryUser", data.foundUser);
      setAuthState({
        ...authState,
  ...
  const handleTestLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("magnetLibraryToken", data.encodedToken);
      localStorage.setItem("magnetLibraryUser", JSON.stringify(data.foundUser));
      setAuthState({
        ...authState,
        authToken: data.encodedToken,
        authUser: data.foundUser,
